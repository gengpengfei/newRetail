...
export default class Banner extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            currentPage: 0,
            title:this._initTitle(this.props.imgArr),
        };
    }

    _initTitle(imgArr:array){
      if (imgArr.length > 0) {
        return imgArr[0].title;
      }else {
        return '';
      }
...
//初始化默认值
    ...
    getTitle(index){
      let item = this.props.imgArr[index]?this.props.imgArr[index]:{};
      return this.props.isHasTitle?item.title : '';
    }
        ...
        return (
            <View style={{height: this.props.figureHeight}}>
                        ...
                        this.props.imgArr.map((value, index) => {
                            ...
                            >
                                <Image
                                    ...
                                    resizeMode="cover"
                                    style={{height: this.props.figureHeight, width: width,resizeMode:"cover"}}
                                />
                            </TouchableHighlight>
                        })
                    }
                ...
                <View style={{
                    ...
                    backgroundColor: this.props.isHasDotBackground ? this.props.dotBackgroundColor : 'transparent',
                    position: 'absolute',
                    bottom: 0,
                    flexDirection: 'row',
                }}>
