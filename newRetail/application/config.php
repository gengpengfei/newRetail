...
return [
    ...
    // 应用调试模式
    'app_debug'              => \think\Env::get('config.app_debug','false'),
    // 应用Trace
    'app_trace'              => false,
    // 应用模式状态
    'app_status'             => '',
    ...
    'exception_handle'       => '\\app\\common\\exception\\HException',
    ...
    'client' => [
        'appKey' => '33ef468331d9c5743f94591f',
        'masterSecret' => 'e758a7b6b8f09bd2a4fb4e34'
    ],
];
