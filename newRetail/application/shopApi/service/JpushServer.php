...
class JpushServer{
//    private $app_key = '66049cffc201f241bd435f71';          //待发送的应用程序(appKey)，只能填一个。正式
    private $app_key = '98948ba174be4cbdc1426533';      //测试
//    private $master_secret = '3b5f92f018e3b4687ff1019d';  //  fece784bc22bc918e5890d8b 测试版本     //主密码 正式
    private $master_secret = 'fece784bc22bc918e5890d8b';//测试
    ...
    public function order_push($userId,$data)
    {
//        $userId =array ( 'alias' => Array ('3391' ,'3392'));
        //组装需要的参数
        $m_type="";
        $m_txt = "";
        $m_time =86400;  //离线保留时间
        //调用推送,并处理
        $result = $this->push($userId,$data,$m_type,$m_txt,$m_time);
        if($result){
    ...
    */
    protected function push($receiver='all',$content='',$m_type='',$m_txt='',$m_time='86400'){
    ...
    //推送的Curl方法
    protected function push_curl($param="",$header="") {
