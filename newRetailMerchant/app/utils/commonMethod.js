...
function checkImageUrl (imagPath) {
  return isUrlStr (imagPath)
    ? imagPath
    : 'https://static.oschina.net/uploads/img/201712/06161126_E45W.png';
}
...
function configServerImagePath (imgPathArr, sizeStr = '/small') {
  // small,thum
  let resultImagePath =
    'https://tse2-mm.cn.bing.net/th?id=OIP._vIZv8w9Ue241473sQl7DgHaHa&w=212&h=209&c=7&o=5&dpr=2&pid=1.7';
