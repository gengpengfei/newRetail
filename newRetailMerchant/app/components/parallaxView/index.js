...
class ParallaxScrollView extends Component {
	...
	/*
   * Expose `ScrollView` API so this components is composable with any components that expects a `ScrollView`.
   */
	getScrollResponder() {
   ...
   */
	...
	_renderFooterSpacer({ contentBackgroundColor }) {
		if(this.props.showfooterSpacer){
			return (
				<View
