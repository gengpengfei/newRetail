...
trait BuildParam{
    ...
    /**
     * [生成随机字符串]
     * @ 0-存数字字符串；1-小写字母字符串；2-大写字母字符串； 3-大小写数字字符串；4-大写字母数字字符 5-字符；
     *   6-数字，小写，大写，字符混合
     ...
     */
    function randSole($type = 0,$length = 6,$time=0){
            ...
            case 4:
                for((int)$i = 0;$i <= $length;$i++){
                    if(mb_strlen($str) == $length){
                        ...
                        $rand = "123456789QWERTYUIOPLKJHGFDSAZXCVBNM";
     ...
     * @param  integer $length [字符串的长度]
     */
    public function get62($length = 8){
